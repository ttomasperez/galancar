	...
	Perfil(String dni_user) {
		...
		btnCambiarContrasea.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// VALIDADOR CONTRASEÑA ANTIGUA
				if (contrasena1.equals(oUsuario.getContrasena())) {
					JOptionPane.showMessageDialog(null, "No puedes introducir una contraseña igual a la que ya tenías",
							"Error", JOptionPane.ERROR_MESSAGE);
				} else {
					// SI LAS DOS CONTARSEÑAS SON IGUALES
					if (contrasena1.equals(contrasena2)) {
						...
						JOptionPane.showMessageDialog(null, "Las contraseñas son diferentes", "Error",
								JOptionPane.ERROR_MESSAGE);
					}
				}// FIN VALIDADOR CONTRASEÑA ANTIGUA
			}
		});
